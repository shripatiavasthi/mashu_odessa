      ...
      <AppGradient style={styles.gradient}>
        <LinearGradient
          ...
          <View style={styles.headerContent}>
            ...
            <Text style={styles.headerTitle}>{displayName} ({termCode})</Text>
          </View>
        </LinearGradient>
        ...
        >
          <View style={styles.modalOverlay}>
            <View style={styles.modalContainer}>
              ...
              <View style={styles.valueConatiner}>
                <Text style={styles.value}>{formatEventDateTime(selectedEvent?.checkInDate, selectedEvent?.checkInTime)}</Text>
              </View>
              <View style={styles.modalDivider} />
